		...
		<fieldset>
			<div class="control-group" style="width: 60%;">
				<div class="form-group">
					...
					<input type="email" class="form-control" id="teacherId" placeholder="아이디를 입력하세요">
				</div>
				<div class="form-group">
					<label for="teacherPw">비밀번호</label>
					<input type="email" class="form-control" id="teacherPw" placeholder="비밀번호를 입력하세요">
				</div>
				<div class="form-group">
					<label for="teacherPwChk">비밀번호 확인</label>
					<input type="email" class="form-control" id="teacherPwChk" placeholder="비밀번호를 다시 입력하세요">
				</div>
