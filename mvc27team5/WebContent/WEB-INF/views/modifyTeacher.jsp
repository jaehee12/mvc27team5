...
<body>
	<div class="col-md-6 col-md-offset-3">
		<h1>Teacher 수정</h1>
		<form id="uTeacherForm" action="<%=request.getContextPath()%>/modifyTeacher.jjdev" method="post">
			<input type="hidden" name="teacherNo" value="<%= teacher.getTeacherNo() %>">
			<div class="form-group update-teacher-id">
				<label>아이디</label>
				<div class="input-group">
					<input type="text" class="form-control" id="uTeacherId" name="uTeacherId" value="<%= teacher.getTeacherId() %>" readonly>
				</div>
				<p></p>
			</div>
			<div class="form-group update-teacher-pw">
				...
				<div class="input-group">
					...
					<input type="password" class="form-control" id="uTeacherPw" name="uTeacherPw" value="<%= teacher.getTeacherPw() %>">
				</div>
			...
			<div class="form-group update-teacher-pw-check">
				...
				<div class="input-group">
					<span class="input-group-addon"></span>
					<input type="password" class="form-control" id="uTeacherPwCheck" name="uTeacherPwCheck" value="<%= teacher.getTeacherPw() %>">
				</div>
				<p>비밀번호가 일치하지 않습니다</p>
			</div>
			<div class="progress">
