...
<body>
	...
	<% Student student = (Student)request.getAttribute("student"); %>
		<div class="col-md-6 col-md-offset-3">
			<h1>Student 추가</h1>
			<form id="uStudentForm" action="<%=request.getContextPath()%>/modifyStudent.jjdev" method="post">
				<input type="hidden" name="studentNo" value="<%= student.getStudentNo() %>">
					<div class="form-group update-student-id">
						<label>이름</label>
						<div class="input-group">
							<input type="text" class="form-control" id="uStudentId" name="uStudentId" value="<%= student.getStudentId() %>" readonly>
						</div>
						<p></p>
					</div>
					<div class="form-group update-student-pw">
						...
						<div class="input-group">
							...
							<input type="password" class="form-control" id="uStudentPw" name="uStudentPw" value="<%= student.getStudentPw() %>">
						</div>
					...
					<div class="form-group update-student-pw-check">
						...
						<div class="input-group">
							<span class="input-group-addon"></span>
							<input type="password" class="form-control" id="uStudentPwCheck" name="uStudentPwCheck" value="<%= student.getStudentPw() %>">
						</div>
						<p>비밀번호가 일치하지 않습니다</p>
					</div>
					<div class="progress">
